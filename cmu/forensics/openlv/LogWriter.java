...
public class LogWriter
{
     ...
     * @param pFile the "permnent" file to log to - OpenLV.log
     */
    public LogWriter(String tFile, String pFile){
	    ...
	    if(permfile.exists()){
		    if(permfile.length() > OpenLVLauncher.BYTES_PER_MB * 5){
			    try{
				permfile.delete();
    ...
    public static void log(String message)
    {
        if(logger == null)
        {
            try 
            {
                ...
                logger = Logger.getLogger("cmu.forensics.openlv");
                ...
                logger.info("Note: This is a log file for OpenLV.  It can safely be deleted.");
                logger.info("============================START============================");
            } 
            catch (IOException e) 
            {

...
"LiveView.EnableAdvancedFeatures=false \r\n" +
"#\r\n" +
"#Default RAM size (must be a multiple of 4)\r\n" +
"#LiveView.DefaultRamSize=1024\r\n" +
"\r\n" +
...
"LiveView.DefaultSystemTime=<NOW>\r\n" +
"#LiveView.DefaultSystemTime=MMM dd yyyy HH:mm:ss z\r\n" +
"#LiveView.DefaultSystemTime=Dec 08 1979 11:20:01 CST\r\n" +
"#LiveView.DefaultSystemTime=Dec 08 1979 11:20:01 -600\r\n" +
"\r\n" +
"#default state of radio buttons (set to true or false)\r\n" +
"LiveView.DefaultClearPassword=true\r\n" +
"LiveView.DefaultClearDomainPassword=true\r\n" +
"LiveView.DefaultDumpHives=true\r\n" +
"\r\n" +
"#default output directory, <HOME> indicates your home directory\r\n" +
"#use the full path to specify another directory, backslashes must be escaped: C:\\\\temp\\\\liveview\\\\VMs\r\n" +
"LiveView.DefaultOutputDirectory=<HOME>\r\n" +
"#LiveView.DefaultOutputDirectory=C:\\temp\r\n" +
"\r\n" +
...
"#LiveView.FileSeperator=; \r\n" +
"#Note the space after the ; !!\r\n" +
"\r\n" +
"\r\n" +
"#the number of physical devices that should be enumerated when LiveView looks for Physical Disk evidence\r\n" +
"#you likely only need to increase this if your exam machine has more than 30 physical devices (IDE/SATA/Fibrechannel/etc)\r\n" +
"#LiveView.MaxPhysicalDrives=60\r\n" +
"\r\n" +
"\r\n" +
"\r\n" +
""

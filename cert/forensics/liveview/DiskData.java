...
public class DiskData 
{
	...
	public void setFiles(String[] f,JFrame frame,File outDir) throws LiveViewException
	{
	...
	private boolean checkDisk(JFrame frame, File outDir) throws LiveViewException
	{
		boolean retVal = true;
...
*/
	...
	public void createVMDKfile(File outputDir) throws LiveViewException
	{
		...
		final boolean startFromScratch;   
			...
			{
			    throw new LiveViewException("Could not create file: " + outFileVMDKName + " in " + outputDir 
				    + endL
				    + ioe.getMessage());  
			}
		    }
		    ...
		    {
			throw new LiveViewException(outFileVMDKName + " in " + outputDir+ " is not writable."
				+ endL

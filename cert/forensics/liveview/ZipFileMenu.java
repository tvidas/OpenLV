...
public class ZipFileMenu extends JDialog
{
	...
	public ZipFileMenu(JFrame p, File wd)//LiveViewLauncher p)//String displayText, String underlyingValue)
	{
		parent = p;
		workingDir = wd;
	}
	public ZipData showDialog(){
		...
		win.setIconImage(new ImageIcon(InternalConfigStrings.getString("LiveViewLauncher.FrameIconPath")).getImage());
		...
		outputFileField.setText(InternalConfigStrings.getString("LiveViewLauncher.DefaultHelpOutputDir"));
		outputFileField.setToolTipText(InternalConfigStrings.getString("LiveViewLauncher.ToolTipHelpOutputDir"));
...
//		physicalDeviceSelectionPanel.add(physicalDeviceCombo);      //add combo box
		...
		helpMessageArea.insert(InternalConfigStrings.getString("LiveViewLauncher.DefaultHelpMessage"),0);
		helpMessageArea.setToolTipText(InternalConfigStrings.getString("LiveViewLauncher.ToolTipHelpMessage"));
		...
		contactName.setText(InternalConfigStrings.getString("LiveViewLauncher.DefaultHelpContactName"));
		contactName.setToolTipText(InternalConfigStrings.getString("LiveViewLauncher.ToolTipHelpContactName"));
		...
		emailAddr.setText(InternalConfigStrings.getString("LiveViewLauncher.DefaultHelpEmail"));
		emailAddr.setToolTipText(InternalConfigStrings.getString("LiveViewLauncher.ToolTipHelpEmail"));
